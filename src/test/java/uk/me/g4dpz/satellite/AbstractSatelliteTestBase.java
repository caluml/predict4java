 ...
 */
abstract class AbstractSatelliteTestBase {
  ...
  static final String[] DEEP_SPACE_TLE = {
      "AO-40",
  ...
  static final String[] GEOSYNC_TLE = {
      "EUTELSAT 2-F1",
  ...
  static final String[] MOLNIYA_TLE = {
      "MOLNIYA 1-80",
  ...
  static final String[] WEATHER_TLE = {
      "TIROS N [P]",
  ...
  static final String[] DE_ORBIT_TLE = {
      "COSMOS 2421 DEB",
  ...
  static final String[] NIL_START_TLE = {
      "0 AO-51 [+]",
      TLE_AO51_1,
      TLE_AO51_2};
}
